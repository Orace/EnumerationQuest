...
namespace EnumerationQuest.Consumers
{
    ...
    {
        public static IEnumerableConsumer<TSource, int> IndexOf<TSource>(TSource value)
        {
            return new IndexOfConsumer<TSource>(value, EqualityComparer<TSource>.Default);
        }

        public static IEnumerableConsumer<TSource, int> IndexOf<TSource>(TSource value, IEqualityComparer<TSource> comparer)
        {
            if (comparer is null)
                throw new ArgumentNullException(nameof(comparer));

            return new IndexOfConsumer<TSource>(value, comparer);
        }
    }
