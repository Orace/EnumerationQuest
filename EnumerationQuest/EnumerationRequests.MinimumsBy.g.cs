...
namespace EnumerationQuest
{
    ...
    {
        #region MinimumsBy with keySelector

        /// <summary>
        /// 	<para>
        /// 		Requests the evaluation of the values with the minimum key in a sequence; according to a specified key selector function.
        /// 	</para>
        /// 	<para>
        /// 		The result of this request is a <see cref="List{TSource}"/> containing the values with the minimum key in the sequence.
        /// 	</para>
        /// </summary>
        /// <remarks>
        /// 	<para>
        ...
        /// <seealso cref="Enumerable.MinBy{TSource,TKey}(IEnumerable{TSource}, Func{TSource,TKey})"/>
        ...
        public static EnumerationRequests1<TSource, List<TSource>> GetMinimumsBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) 
        {
            return new EnumerationRequests1<TSource, List<TSource>>(source, ConsumerFactory.MinimumsBy<TSource, TKey>(keySelector));
        }
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests2<TSource, TResult1, List<TSource>> AndMinimumsBy<TResult1, TSource, TKey>(this EnumerationRequests1<TSource, TResult1> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));

            return source.Add(ConsumerFactory.MinimumsBy<TSource, TKey>(keySelector));
        }
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests3<TSource, TResult1, TResult2, List<TSource>> AndMinimumsBy<TResult1, TResult2, TSource, TKey>(this EnumerationRequests2<TSource, TResult1, TResult2> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests4<TSource, TResult1, TResult2, TResult3, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TSource, TKey>(this EnumerationRequests3<TSource, TResult1, TResult2, TResult3> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests5<TSource, TResult1, TResult2, TResult3, TResult4, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TSource, TKey>(this EnumerationRequests4<TSource, TResult1, TResult2, TResult3, TResult4> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests6<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TResult5, TSource, TKey>(this EnumerationRequests5<TSource, TResult1, TResult2, TResult3, TResult4, TResult5> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests7<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TSource, TKey>(this EnumerationRequests6<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests8<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TSource, TKey>(this EnumerationRequests7<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests9<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TSource, TKey>(this EnumerationRequests8<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests10<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9, TSource, TKey>(this EnumerationRequests9<TSource, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9> source, Func<TSource, TKey> keySelector) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        #region MinimumsBy with keySelector, comparer

        /// <summary>
        /// 	<para>
        /// 		Requests the evaluation of the values with the minimum key in a sequence; according to a specified key selector function and key comparer.
        /// 	</para>
        /// 	<para>
        /// 		The result of this request is a <see cref="List{TSource}"/> containing the values with the minimum key in the sequence.
        /// 	</para>
        ...
        /// <param name="keySelector">A function to extract the key for each element.</param>
        /// <seealso cref="Enumerable.MinBy{TSource,TKey}(IEnumerable{TSource}, Func{TSource,TKey}, IComparer{TKey})"/>
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests1<TSource, List<TSource>> GetMinimumsBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) 
        {
            return new EnumerationRequests1<TSource, List<TSource>>(source, ConsumerFactory.MinimumsBy<TSource, TKey>(keySelector, comparer));
        }
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests2<TSource, TResult1, List<TSource>> AndMinimumsBy<TResult1, TSource, TKey>(this EnumerationRequests1<TSource, TResult1> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));

            return source.Add(ConsumerFactory.MinimumsBy<TSource, TKey>(keySelector, comparer));
        }
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests3<TSource, TResult1, TResult2, List<TSource>> AndMinimumsBy<TResult1, TResult2, TSource, TKey>(this EnumerationRequests2<TSource, TResult1, TResult2> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests4<TSource, TResult1, TResult2, TResult3, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TSource, TKey>(this EnumerationRequests3<TSource, TResult1, TResult2, TResult3> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static EnumerationRequests5<TSource, TResult1, TResult2, TResult3, TResult4, List<TSource>> AndMinimumsBy<TResult1, TResult2, TResult3, TResult4, TSource, TKey>(this EnumerationRequests4<TSource, TResult1, TResult2, TResult3, TResult4> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) 
        {
            if (source is null)
                throw new ArgumentNullException(nameof(source));
